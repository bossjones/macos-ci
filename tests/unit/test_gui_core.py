...
def test_next_screenshot_sequence_starts_at_one() -> None:
    assert next_screenshot_sequence([]) == 1


def test_next_screenshot_sequence_continues_from_the_highest_existing() -> None:
    assert next_screenshot_sequence(["01-a.png", "02-b.png"]) == 3


def test_next_screenshot_sequence_ignores_unrelated_files() -> None:
